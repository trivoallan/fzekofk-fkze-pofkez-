...
services:
    ...
    mysql: 
        ...
        environment: 
            ...
            MYSQL_DATABASE: fzekofk-fkze-pofkez-
        volumes: 
    ...
    adminer:
        ...
        labels:
            ...
            - "traefik.http.routers.adminer.rule=Host(`adminer.fzekofk-fkze-pofkez-.localhost`)"  
    ...
    php:
        ...
        labels:
            ...
            - "traefik.http.routers.php.rule=Host(`php.fzekofk-fkze-pofkez-.localhost`)"
